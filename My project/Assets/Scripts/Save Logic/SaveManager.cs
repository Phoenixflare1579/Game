...
public class SaveManager : MonoBehaviour
{
    ...
    public void Load()
    {
        ...
        MC.EXP = data.expM;
        MC.MaxHP = data.statsM[0];
        MC.MaxMana = data.statsM[1];
        MC.Speed = data.statsM[2];
        MC.Def = data.statsM[3];
        MC.PhysAtk = data.statsM[4];
        MC.MagicAtk = data.statsM[5];
        MC.MagicDef = data.statsM[6];
        MC.Evasion = data.statsM[7];
        MC.Accuracy = data.statsM[8];
        MC.Crit = data.statsM[9];
        MC.CritDmg = data.statsM[10];
